...
from features.pageobjects.pageobject import UICatalogPage


@given('button found')
def button_found(context):
    page = UICatalogPage(context)
    #page.locator_dictionary["Alert"].click()
    #page.locator_dictionary[0].click()
    #print(page.test)
    #page.alert_menu.click()
    element = page.get_element_by_id(page.locator_dictionary["Alert"])
    #context.driver.find_element_by_accessibility_id(page.locator_dictionary["Alert"]).click()
    element.click()
